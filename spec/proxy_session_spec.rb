...
describe ProxySession do
  ...
  it "initialize should store the provided proxy_options" do
    session = ProxySession.new Initializer.configuration.left, {:dummy => 1}
    session.proxy_options.should == {:dummy => 1}
  end
